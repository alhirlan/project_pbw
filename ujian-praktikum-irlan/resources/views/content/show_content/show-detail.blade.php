...
@section('content')
	...
	<div class="container my-4">
			...
			<h1 class="text-center"> <b> Detail Provider {{ $provider->nama_provider }}</b></h1>
			<hr>
		        		...
		        		<div class="col-lg-4 col-md-6 col-s-12 mb-4">
		        			<div class="card p-2 mx-4">
		        			  ...
		        			  <div class="card-footer text-center text-muted">
		        			  		<div class="row">
		        			  	    <div class="col">
		        			  	      <a class="btn btn-success btn-lg" href="{{ route('edit/data_provider', ['dataprovider' => $dataprovider->id, 'provider' => $provider->id]) }}">Ubah</a>
		        			  	    </div>
		        			  	  </div>
		        			  </div>
		        			</div>
